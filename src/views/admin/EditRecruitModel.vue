<template>
  <div>
    <el-container>
      <el-header style="box-shadow: 0 2px 4px rgba(0, 0, 0, .12), 0 0 6px rgba(0, 0, 0, .04)">编辑面经模板</el-header>
      <el-main
  ...
  methods: {
    async submit() {
      ...
      if (res != null) {
        ...
        this.$router.push("/recruitModelList");
      }
    },
    async save() {
      console.log(this.form);
      ...
      if (res != null) {
        this.$message.success("更新成功！");
        this.$router.push("/recruiModeltList");
      }
    },
    async get() {
