  ...
  <div style="height:100%">
    <el-container>
      <el-header style="box-shadow: 0 2px 4px rgba(0, 0, 0, .12), 0 0 6px rgba(0, 0, 0, .04)">
        题目列表
        <el-button @click="dialogAddVisible = true" type="text" style="color:#303133">添加题目</el-button>
      </el-header>
      <el-main
    ...
    <!-- 添加题目dialog -->
    <el-dialog title="添加题目" :visible.sync="dialogAddVisible" center>
      <el-form :model="addForm" ref="updateFormRef">
        ...
        <el-form-item label="C选项" v-if="addForm.type == 1" :label-width="formLabelWidth">
          <el-input v-model="addForm.c"></el-input>
        </el-form-item>
        <el-form-item label="D选项" v-if="addForm.type == 1" :label-width="formLabelWidth">
    ...
    <!-- 编辑题目dialog -->
    <el-dialog title="编辑题目" :visible.sync="dialogUpdateVisible" center>
      <el-form :model="updateForm" ref="updateFormRef">
        ...
        <el-form-item label="标签" :label-width="formLabelWidth">
          <el-input v-model="updateForm.biz_type"></el-input>
        </el-form-item>
        <el-form-item label="状态" :label-width="formLabelWidth">
        ...
        <el-form-item
          ...
          :label-width="formLabelWidth"
        >
          <el-input v-model="updateForm.a"></el-input>
        </el-form-item>
        <el-form-item
          label="B选项"
          v-if="updateForm.type == 1 || updateForm.type == 2"
          :label-width="formLabelWidth"
        >
          <el-input v-model="updateForm.b"></el-input>
        </el-form-item>
        <el-form-item label="C选项" v-if="updateForm.type == 1" :label-width="formLabelWidth">
          <el-input v-model="updateForm.c"></el-input>
        </el-form-item>
        <el-form-item label="D选项" v-if="updateForm.type == 1" :label-width="formLabelWidth">
          <el-input v-model="updateForm.d"></el-input>
        </el-form-item>
        <el-form-item label="答案" :label-width="formLabelWidth">
...
export default {
  ...
  methods: {
    ...
    handleEdit(index, row) {
      ...
      this.updateForm.biz_type = row.bizType;
      this.updateForm.answer = row.answer;
      this.updateForm.a = row.aselect;
      this.updateForm.b = row.bselect;
      this.updateForm.c = row.cselect;
      this.updateForm.d = row.dselect;
